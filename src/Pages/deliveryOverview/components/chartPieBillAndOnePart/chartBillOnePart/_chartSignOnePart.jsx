...
const Index = ()=>{
    ...
    const orderTotal =  pageState.listSignOnePart.arr_total_orders
    const chartSeries = pageState.listSignOnePart.arr_total_cod
