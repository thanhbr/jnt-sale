...
import usePaymentManagementRow from "../../hooks/usePaymentManagementRow";

const ReceiptTr = ({data, ...props}) => {
    const receiptRow = usePaymentManagementRow(data)
    ...
    return (
        <StyledTBodyReceipt>
            <Tr
                {...props}
                className="payment-management-table__row"
                extra={
                    <RowOrderExtra
                        id={detail?.id}
            ...
            >
                <Td className="payment-management-table__cell payment-management-table__cell-code" data-type="td">
                    ...
                    <div style={{position: 'relative'}}>
                        ...
                        <Tooltip title={'Ngày tạo phiếu'} placement={'bottom'}>
                            <span>{PAYMENT_MANAGEMENT_ICONS.clock}</span>
                        </Tooltip>
                        <Text color={'#7C88A6'}
                              fontSize={13}
                ...
                <Td className="payment-management-table__cell" data-type="td">
                ...
                <Td className="payment-management-table__cell" data-type="td">
                    {+data?.status === 1 ? (
                        <div style={{background: '#E6FFF2', padding: '4px 12px', borderRadius: 4}}>
                            <Text color={'#00AB56'} fontSize={12}>Hoàn thành</Text>
                        </div>
                    ) : (
                        <div style={{background: '#EFF3FB', padding: '4px 12px', borderRadius: 4}}>
                ...
                >
                    <button
                        className="payment-management-table__detail-toggle"
                        data-active={row.shouldOpenDetail}
                        onClick={row.onToggleDetail}
                    >
                        {PAYMENT_MANAGEMENT_ICONS.up}
                    </button>
...
.payment-management-table {
  ...
  background: transparent !important;
    &:hover {
      .payment-management-table__detail-toggle {
        display: block;
      }
    }
  }
