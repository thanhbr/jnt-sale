...
export const ProductGroupExport = ({data, ...props}) => {
    ...
    return (
        <StyledProductGroupExport {...props} style={{visibility: confirm.active ? 'hidden' : 'visible'}}>
