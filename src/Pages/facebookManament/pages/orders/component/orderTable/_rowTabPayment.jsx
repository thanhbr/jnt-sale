    ...
    <StyledRowTabPayment {...props}>
      <div style={{display: 'flex'}}>
        <div style={{marginRight: 86}}>
          <Text AS="B" fontSize={15} fontWeight={600} lineHeight={22} style={{marginRight: 8}}>
            Đã thanh toán:
          </Text>
          <Text
            as="b"
      ...
      <div style={{position: 'absolute', top: 0, right: 0}}>
        {shouldShowSubmitPayment && (
          <>
            <Button style={{width:'159px',padding: '0 12px'}} size="sm" onClick={row.onOpenSubmitPaymentModal}>
              Xác nhận thanh toán
            </Button>
