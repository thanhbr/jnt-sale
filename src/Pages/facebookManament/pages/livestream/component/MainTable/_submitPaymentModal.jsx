...
export const SubmitPaymentModal = ({data, onClose, ...props}) => {
  ...
  return (
    <StyledSubmitPaymentModal {...props} onClick={onClose}>
      <div
        className="livestream-table-facebook__submit-payment-modal__container"
        onClick={e => e.stopPropagation()}
      >
        <div className="livestream-table-facebook__submit-payment-modal__header">
          <Text as="h2" fontSize={19} lineHeight={28}>
            XÁC NHẬN THANH TOÁN CHO HÓA ĐƠN {data.id}
          </Text>
        </div>
        <div className="livestream-table-facebook__submit-payment-modal__body">
          <div className="livestream-table-facebook__submit-payment-modal__figures">
            {figureList.map(item => (
              <div
                key={item.id}
                className="livestream-table-facebook__submit-payment-modal__figure-item"
              >
          ...
          <div className="livestream-table-facebook__submit-payment-modal__form">
            <div className="livestream-table-facebook__submit-payment-modal__input">
              <Select
                className="livestream-table-facebook__submit-payment-modal__select"
              ...
              >
                {paymentMethodList.length > 0 &&
                  paymentMethodList.map(item => (
                    <Option
                      key={item.id}
                      className="livestream-table-facebook__submit-payment-modal__option"
        ...
        <div className="livestream-table-facebook__submit-payment-modal__footer">
          <Button
            size="sm"
            appearance="ghost"
            style={{minWidth: 110}}
...
const StyledSubmitPaymentModal = styled.div`
  ...
  .livestream-table-facebook__submit-payment-modal {
    &__container {
      width: 600px;
      padding: 24px;
