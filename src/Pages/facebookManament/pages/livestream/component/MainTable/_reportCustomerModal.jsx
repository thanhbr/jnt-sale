...
export const ReportCustomerModal = ({data, ...props}) => {
  ...
  return (
    <StyledReportCustomerModal {...props} onClick={data?.onClose}>
      <div
        className="livestream-table-facebook__report-customer-modal__container"
        onClick={e => e.stopPropagation()}
      >
        <div className="livestream-table-facebook__report-customer-modal__header">
        ...
        <div className="livestream-table-facebook__report-customer-modal__body">
          {data?.mode !== 'view' && (
            <div className="livestream-table-facebook__report-customer-modal__tabs">
              <div
                className="livestream-table-facebook__report-customer-modal__tab-item"
              ...
              {reportList.length > 0 ? (
                ...
                <div className="livestream-table-facebook__report-customer-modal__tab-item">
        ...
        <div className="livestream-table-facebook__report-customer-modal__footer">
          <Button
            size="sm"
            appearance="ghost"
            style={{minWidth: 110}}
...
const TabForm = ({data, content, onContentChange}) => {
  return (
    <div className="livestream-table-facebook__report-customer-moda__tab-form">
      <div className="livestream-table-facebook__report-customer-modal__input-group">
        <Input
          className="livestream-table-facebook__report-customer-modal__input-item"
        ...
        />
        <Textarea
          className="livestream-table-facebook__report-customer-modal__textarea-item"
          label={
            <>
...
const TabList = ({list, loading}) => {
  return (
    <div className="livestream-table-facebook__report-customer-modal__tab-list">
      <div className="livestream-table-facebook__report-customer-modal__table">
        <div className="livestream-table-facebook__report-customer-modal__thead">
          <div className="livestream-table-facebook__report-customer-modal__tr">
            <div className="livestream-table-facebook__report-customer-modal__th">
              Shop cảnh báo
            </div>
            <div className="livestream-table-facebook__report-customer-modal__th">
              Ngày báo cáo
        ...
        <div className="livestream-table-facebook__report-customer-modal__tbody">
          {loading
            ? Array.from(Array(2), (e, i) => <ReportListPlaceholder key={i} />)
            : list.map((item, i) => (
                <div key={i} className="livestream-table-facebook__report-customer-modal__tr">
                  <div className="livestream-table-facebook__report-customer-modal__td">
                    {item?.shop || '---'}
                  </div>
                  <div className="livestream-table-facebook__report-customer-modal__td">
                    {item?.dt_created
...
const ReportListPlaceholder = ({...props}) => {
  return (
    <div {...props} className="livestream-table-facebook__report-customer-modal__tr">
      {Array.from(Array(3), (e, i) => (
        <div key={i} className="livestream-table-facebook__report-customer-modal__td">
          <Skeleton
            sx={{
              width: '100%',
              height: 33,
...
const StyledReportCustomerModal = styled.div`
  ...
  .livestream-table-facebook__report-customer-modal {
    &__container {
      width: 600px;
      padding: 24px;
