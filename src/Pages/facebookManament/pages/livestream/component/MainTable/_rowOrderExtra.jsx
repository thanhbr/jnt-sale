...
import {ORDER_TABLE_ROW_EXTRA_TABS} from '../../interface/_const'
...
export const RowOrderExtra = ({id, active, data, rowData, ...props}) => {
  ...
  return (
    <StyledRowOrderExtra {...props} data-active={active}>
      {active && (
        <div className="row-livestream-extra__container">
          <div className="row-livestream-extra__tabs">
            {ORDER_TABLE_ROW_EXTRA_TABS.map(item => (
              <div
                key={item.id}
                className="row-livestream-extra__tab"
          ...
          <div className="row-livestream-extra__content common-scrollbar">
            {id === data?.id ? (
              <>
                {activeTab === 'detail' && (
                  <RowTabDetail data={data} rowData={rowData} />
                )}
                {activeTab === 'shipping' && <RowTabShipping data={data} />}
                {activeTab === 'payment' && (
              ...
              <div className="row-livestream-extra__loading">
