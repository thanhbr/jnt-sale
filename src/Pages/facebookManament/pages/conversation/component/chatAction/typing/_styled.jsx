...
export const StyledFacebookResponseContentScriptDetailDrawer = styled.div`
  ...
  .facebook-response-content-script-detail-drawer__galleries-list::-webkit-scrollbar-track {
    -webkit-box-shadow: inset 0 0 0px rgba(0, 0, 0, 0);
  }
  
  .facebook-response-content-script-detail-drawer__galleries-list::-webkit-scrollbar-thumb {
    height: 5px;
    background-color: #d5ac68;
  }
  
  .facebook-response-content-script-detail-drawer__galleries-list::-webkit-scrollbar-thumb:hover {
    background-color: #f1db9d;
  }
  
  .facebook-response-content-script-detail-drawer__galleries-list::-webkit-scrollbar  {
