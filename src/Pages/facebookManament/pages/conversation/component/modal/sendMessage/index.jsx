...
const SendMessage = ({ ...props }) => {
  const { comment } = useFacebookDetailConversation()
  return (
    <>
      <ConfirmModal
...
const Body = () => {
  ...
  const { typing, methods } = useFacebookConversationTyping()
  const inputRef = useRef()
  const message = data.detail?.conversation?.message
    ...
    <Styled>
      <div className={'message-modal__header'}>
        ...
        <div className="message-modal__header-avatar">
          <ReactImageFallback
            src={data.detail?.conversation?.customer?.avatar}
            fallbackImage="/img/facebook/fb_avatar.jpg"
            alt={data.detail?.conversation?.customer?.name}
