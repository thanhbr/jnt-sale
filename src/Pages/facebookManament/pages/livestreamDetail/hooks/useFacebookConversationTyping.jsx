...
const useFacebookConversationTyping = () => {
    ...
    const typing = state.detail.liveStream.typing
    const detail = state.detail.liveStream
    ...
    const handleSelectItem = (data, opt = {}) => {
        ...
        if ([...imageTemp, ...listImage].length > 1) {
            showAlert({
                type: 'warning',
