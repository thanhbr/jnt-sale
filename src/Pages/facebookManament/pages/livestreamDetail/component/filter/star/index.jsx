...
export const Star = ({ ...props }) => {
  ...
  const isStar = data.filter?.liveStream?.isStar

  const handleItemClick = (data) => {
    methods.handleFilterStarComment(data)
  }
  const listStarComment = [
    { id: 2, name: 'Bình luận được gắn sao' },
    { id: 1, name: 'Bình luận không được gắn sao' },
  ]
        ...
        >
          {
            !isActionActive
              ?
              <Tooltip placement="right" title={'Lọc theo bình luận được gắn sao'}>
                <div
          ...
          <StyledRowMenuPopover>
            <div className={'filter-content'} ref={wrapperRef}>
              <div className={'filter__title'}>
                <Text fontWeight={600}>Bình luận được gắn sao</Text>
              </div>
