...
export const TagCustomer = () => {
  ...
  const tagsCustomer = data.filter.liveStream.tagsCustomer
  const settings = {
    dots: false,
    infinite: false,
    speed: 500,
    ...
    <StyledTags>
      {
        ...
        <div>
          ...
          {openBomModal == true && <ReportCustomerModal data={data.detail.customerInfor.list} openModal={openBomModal} closeModal={()=> setOpenBomModal(false)}/>}
        </div>
      }
      <CreateStickers/>
    </StyledTags>
