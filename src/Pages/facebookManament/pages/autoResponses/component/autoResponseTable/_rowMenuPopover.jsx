...
import {CONVERSATION_TABLE_ROW_MENU_POPOVER, ICONS} from "../../interface/_constants";
  ...
  return (
    <>
      <StyledIconToggle
        ...
        onClick={handleClick}
      >
        <div className={'common-icon'} data-active={open}>{ICONS.manipulation}</div>
      </StyledIconToggle>
      <Popover
        id={id}
      ...
      >
        <StyledRowMenuPopover>
          {CONVERSATION_TABLE_ROW_MENU_POPOVER.map((item, key) => (
              <li
                key={item.id}
