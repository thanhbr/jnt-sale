...
import {
  ForControlCOD_MANAGER_ROW_EXTRA_TAB_SHIPPING_REQUIREMENTS,
  ForControlCOD_MANAGER_TABLE_ROW_EXTRA_TAB_SHIPPING_PAYMENT_METHODS
} from 'Pages/ForControlCOD/Tab1/interfaces/_constants'
...
export const RowTabDetailForControlCOD = ({
  data,
  onActionCancelForControlCOD,
  setOpenEditCODModal,
  status,
  ...props
}) => {
        ...
        <div style={{position: 'absolute', top: 0, right: 0}}>
          {status == 1 && (
            <Button
              ...
              size="sm"
              style={{marginRight: 8}}
              onClick={() => onActionCancelForControlCOD(2, data?.order_id)}
            >
                {t("cancel_send")}
            </Button>
          )}
          {((['1', '8'].includes(status) && ['1'].includes(data?.partner_ship)) || (['21'].includes(status))) && (
            // <CustomToolTip placement="top" title="Tính năng đang phát triển">
              <Button appearance="primary" size="sm" onClick={() => navigate(`/order/edit/${data.order_id}`, {state: {from: location.pathname } })}>
                  {t("edit_order_n")}
              </Button>
            // </CustomToolTip>
          )}
            ...
            <div style={{width: '32.5%'}}>
              ...
              >
                ...
                >
                  <CustomToolTip
                    placement="top-start"
                    title={t("order_cod_amount")}
                  >
                    {ForControlCOD_ICONS.question}
                  </CustomToolTip>
                </span>
              </Text>
              <Text
          ...
          <div className="row-tab-detail__table">
            <div className="row-tab-detail__thead">
              <div className="row-tab-detail__tr">
                ...
                <div className="row-tab-detail__th">{t("product_page_product_name")}</div>
