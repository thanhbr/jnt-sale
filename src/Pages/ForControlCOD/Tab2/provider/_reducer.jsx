  ...
  switch (action.type) {
    ...
    case orderActions.OTHER_FILTER_APPLY:
      return {
        ...
        panels: {
          ...state.panels,
          unpaidSum: action.payload?.panels?.unpaidSum,
          count_order_unpaidSum: action.payload?.panels?.count_order_unpaidSum,
          signpaidSum: action.payload?.panels?.signpaidSum,
          count_order_signpaidSum: action.payload?.panels?.count_order_signpaidSum,
        },
      }
