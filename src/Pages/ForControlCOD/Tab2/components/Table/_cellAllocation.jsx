...
import { ForControlCOD_ICONS } from '../../interfaces/_icons'
  ...
  const statusAllocation = [
    {
      ...
      color: '#FF9F41',
      value: daysBetween,
      icon: (ForControlCOD_ICONS.truckTime),
      label: `
      ${t("order_in_delivery_process")} ${daysBetween} ${t("day_n")}
      `
    },
    {
      status: 2,
    ...
    },
    {
      ...
      color: '#00AB56',
      value: daysBetween,
      icon: (ForControlCOD_ICONS.greenTruckTime),
      label: `
      ${t("delivery_process_completed")} ${daysBetween > 0 ? `${t("in")} ${daysBetween} ${t("day_n")}` : t("in_day")}
      `
    },
    {
      status: 4,
