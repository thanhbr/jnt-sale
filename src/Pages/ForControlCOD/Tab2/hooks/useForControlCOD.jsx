...
const useForControlCOD = () => {
  ...
  const handleOriginFetch = async dateTimeValue => {
    ...
    const response = await sendRequestAuth(
      'get',
      `${config.API}/cod/cod-list?multiple_search=${querySearch}&code_type=3&start_date=${startDate}&end_date=${endDate}&date_type=0&per_page=${table.pagination.amount}&start=${table.pagination.active}`,
    )
