...
const CancelReceipt = ({modal, onClose, submit, ...props}) => {
  return (
    <Modal
      open={modal?.open}
      onClose={onClose}
    >
      <StyledCancelReceipt {...props}>
        <Box className={'cancel-receipt-content'}>
          <div>
            <Text fontWeight={600} fontSize={20}>Xác nhận hủy phiếu thu</Text>
          </div>
          <div>
            <Text>Thao tác này sẽ hủy bỏ giá trị của phiếu thu đang chọn. Bạn có chắc chắn muốn thực hiện ?</Text>
          </div>
