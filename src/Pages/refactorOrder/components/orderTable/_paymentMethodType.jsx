...
import usePaymentType from 'Pages/refactorOrder/hooks/usePaymentType'
import ArrayUtils from 'Pages/refactorOrder/utils/array'
import { transformPaymentMethodData } from 'Pages/refactorOrder/utils/transform'
...
export const PaymentMethodType = ({value, onChange, ...props}) => {
  const {data: paymentMethod, properties, methods} = usePaymentType()
    ...
    <>
      <AlternativeAutoComplete
        ...
        inputProps={{
          ...
          readOnly: true,
          value: value?.name || '',
          validateText: paymentMethod?.validate || '',
          validateType: "danger",
          disabled: false //!statusInfo?.canEdit
        }}
        // menu
        menuProps={{
          canLoadMore,
