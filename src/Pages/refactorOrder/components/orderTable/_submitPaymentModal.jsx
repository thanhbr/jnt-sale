...
import { PaymentMethodType } from './_paymentMethodType'
...
export const SubmitPaymentModal = ({data, onClose, ...props}) => {
  ...
  const handleSubmit = async () => {
    const response = await sendRequestAuth(
      ...
      JSON.stringify({
        payment_method_id: Number(paymentMethodValue?.value),
        total_money: Number(replaceAllCustom(paymentMoneyValue,',',''))
      }),
    )
        ...
        <div className="order-table__submit-payment-modal__body">
          ...
          <div className="order-table__submit-payment-modal__form">
            <div className="order-table__submit-payment-modal__input">
              <PaymentMethodType validate={''} value={paymentMethodValue} onChange={setPaymentMethodValue}/>
            </div>
            <div className="order-table__submit-payment-modal__input">
              <CurrencyInput
