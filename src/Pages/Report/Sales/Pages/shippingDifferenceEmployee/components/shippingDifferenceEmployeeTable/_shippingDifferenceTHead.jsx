  ...
  return (
    viewType.value == 1
      ...
      >
        ...
        <>
          <Th className="shipping-fee-management-table__cell shipping-fee-management-table__overview-cell"
              data-type="th">{t('report__created_by')}</Th>
          <Th className="shipping-fee-management-table__cell shipping-fee-management-table__overview-cell"
              data-type="th">
      ...
      >
        ...
        <>
          <Th className="shipping-fee-management-table__cell" data-type="th">{t('report__created_by')}</Th>
