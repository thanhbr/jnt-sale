...
export const OrderOriginFooter = ({ ...props }) => {
  ...
  return (
    <StyledFooter>
      <Tr {...props} type="tHead"
        ...
        <div className="order-origin-management-table-footer__cell" style={{ borderRight: 'none!important' }}>
        ...
        {preOrderDetail.map(order => (
          <div className="order-origin-management-table-footer__cell" data-type="td">
        ...
        <div className="order-origin-management-table-footer__cell" data-type="td">
          ...
          <Text as={'p'} fontSize={13} fontWeight={600}>{panels?.totals?.total_order || 0} <Text
            ...
            <Text
              ...
              fontWeight={600}
              fontSize={11}
            >({fNumber(panels?.totals?.total_rate)}%)</Text>
          </Text>
        </div>
...
.order-origin-management-table-footer {
