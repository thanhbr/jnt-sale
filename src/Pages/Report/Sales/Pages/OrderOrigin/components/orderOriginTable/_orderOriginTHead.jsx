...
export const OrderOriginTHead = ({ ...props }) => {
  ...
  return (
    ...
    >
      <Th className="order-origin-management-table__cell">
        STT
      </Th>
      <>
        <Th className="order-origin-management-table__cell">{t('source_order')}</Th>
        <Th className="order-origin-management-table__cell">{t('Send_delivery')}</Th>
        <Th className="order-origin-management-table__cell">{t('successfully_pick_up_goods')}</Th>
        <Th className="order-origin-management-table__cell">
        ...
        <Th className="order-origin-management-table__cell">{t('Settled')}</Th>
        <Th className="order-origin-management-table__cell">
