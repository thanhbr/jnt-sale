...
export const TimeFilter = () => {
  const { dateTime,pageState } = useOrderFilterForm()
  ...
  return (
    <AlternativeAutoComplete
      ...
      inputProps={{
        ...
        disabled:  pageState.table.display.loading
      }}
      // menu
      menuProps={{
        className: 'report-customer__filter-form'
      }}
  ...
  return (
    <StyledContent>
      ...
      <div className={'datetime-footer'}>
        <Text as={'p'} color={'#1E9A98'} style={{cursor: 'pointer'}} onClick={() => dateTime.onReset(dateTime.type)}> {t('general_reset_to_default')} </Text>
      </div>
    </StyledContent>
  )
}
