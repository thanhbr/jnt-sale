...
import {
  LOCATION_TABLE_THEAD_RETURN_FILTER_LIST,
  LOCATION_TABLE_THEAD_SUCCESS_FILTER_LIST
...
export const ReturnFilterPopover = ({ ...props }) => {
  ...
  const { sortBy, sortType } = useLocationFilterForm()
  const listStatus = props.sortType == 4 ? LOCATION_TABLE_THEAD_SUCCESS_FILTER_LIST : LOCATION_TABLE_THEAD_RETURN_FILTER_LIST
