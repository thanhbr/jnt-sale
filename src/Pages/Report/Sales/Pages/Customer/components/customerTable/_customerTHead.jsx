...
export const CustomerTHead = ({ ...props }) => {
  ...
  return (
    <Tr {...props} type="tHead" style={{
      ...
      <Th className="customer-management-table__cell" data-type="th">
        STT
      </Th>
      <>
          <Th className="customer-management-table__cell" data-type="th">{t('customer')}</Th>
        <Th className="customer-management-table__cell" data-type="th">{t('province_city')}</Th>
        <Th className="customer-management-table__cell" data-type="th">{t('order_quantity')}</Th>
        <Th className="customer-management-table__cell" data-type="th">{t('revenue')}</Th>
        <Th className="customer-management-table__cell" data-type="th">
