...
import { getDateFromNow } from 'Pages/Report/Sales/Pages/shippingDifference/utils/date'
...
export const ShippingDifferenceReducer = (state, action) => {
  switch (action.type) {
    ...
    case shippingActions.FILTER_SOURCE_UPDATE:
      return {
        ...state,
        filter: {
          ...state.filter,
    ...
    case shippingActions.FILTER_SOURCE_KEYWORD_UPDATE:
      return {
        ...state,
        filter: {
          ...state.filter,
