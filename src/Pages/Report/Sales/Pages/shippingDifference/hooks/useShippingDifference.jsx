...
const useShippingDifference = () => {
  ...
  const handleOriginFetch = async dateTimeValue => {
    ...
    const response = await Promise.all([
      sendRequestAuth(
        'get',
        `${config.API}/report/sales/fee/origins?order_origin_id=0&keyword=${querySearch}&start_date=${startDate}&end_date=${endDate}&date_type=sended`,
      ),
    ])
...
export default useShippingDifference
