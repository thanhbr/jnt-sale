  ...
  return (
    <StyledTHead>
      <Tr {...props} type="tHead">
        ...
        <Th className="report-inventory-table__cell">{t('product_page_group_product')}</Th>
        <Th className="report-inventory-table__cell">{t('report__unit')}</Th>
        <Th className="report-inventory-table__cell">{t('general_inventory')}</Th>
        <Th className="report-inventory-table__cell">{t('general_cost_price')}</Th>
        <Th className="report-inventory-table__cell">{t('inventory_val')}</Th>
      </Tr>
    </StyledTHead>
  )
}
