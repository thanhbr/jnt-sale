    ...
    <>
      {SkelentonRows.map(i => (
        <Tr className="table_body" key={i}>
          <Td className="cash-books-table__cell" align="center">
            <div style={{width: '100%'}}>
              <Skeleton width={'100%'} height={31} />
            </div>
          </Td>
          <Td className="cash-books-table__cell" align="left">
            <div style={{width: '100%'}}>
          ...
          <Td className="cash-books-table__cell" align="right">
          ...
          <Td
            className="cash-books-table__cell"
            data-menu="true"
            data-type="td"
            align="right"
          >
