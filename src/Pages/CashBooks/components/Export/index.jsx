...
import ConfirmModalCashBooks from '../ConfirmModal'
import {StyledOrderExport} from './_styled'

export const CashBooksExport = ({data, ...props}) => {
  ...
  return (
    ...
    >
      <ConfirmModalCashBooks confirm={confirm} setConfirm={setConfirm} />
      <div className="order-export__container">
        <div className="order-export__header">
          ...
          <Text as="h5" fontSize={18} fontWeight={700} lineHeight={22}>
            {numberWithCommas(data?.data?.total || 0)} phiếu
          </Text>
...
const Item = ({
  ...
  const handleExport = async () => {
    ...
    const response = await sendRequestAuth(
      'get',
      `${config.API}/cashbook/export-xlsx${queryString}`,
      null,
