  ...
  return (
    <>
      <CategoryInput
        ...
        categoryList={[]}
        categoryValue={{
          name: 'Thời gian ngừng nhận tương tác mới',
          value: '',
          icon: <Icon />,
        }}
        categoryWidth={270}
...
const Icon = () => (
  ...
  <span className="order-filter-form__tooltip">
    <Tooltip
      placement="center"
      title={
        'Lọc danh sách các đơn giao hàng có số ngày chưa nhận tương tác mới ≥ thời gian mà bạn nhập. Ví dụ: Nếu bạn nhập giá trị là 3, thì các đơn giao hàng có số ngày ngừng nhận tương tác từ 3 ngày trở lên sẽ được lọc ra.'
      }
    >
      <svg
        width="16"
