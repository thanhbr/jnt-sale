...
import {PRODUCT_TABLE_ROW_MENU_POPOVER} from "../../interfaces/~constants";
...
export const RowMenuPopover = ({
  ...
  const actionList = PRODUCT_TABLE_ROW_MENU_POPOVER
          ...
          <StyledRowMenuPopover>
            {actionList.map(item => (
              <>
                <Tooltip
                  placement="left"
                  title={!!item?.isDeveloping ? t(DISPLAY_NAME_MENU.GENERAL.COMING_SOON) : ''}
                >
                  <li
                    key={item.id}
