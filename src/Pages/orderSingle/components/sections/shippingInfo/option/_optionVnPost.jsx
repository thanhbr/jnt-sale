...
export const OptionVnpost = ({...props}) => {
        ...
        <div className={'shipping-partner-colslaps-container__item'}>
          <div className={'shipping-partner-colslaps-container__right-item'}>
            ...
            >
              ...
              <Switch onChange={() => methods.onChangeCargoInsurrance(!props?.partner?.config?.cargoInsurrance?.active,props.position)}
                      defaultChecked={props?.partner?.config?.cargoInsurrance?.active}/>
            </div>
            <div className={'shipping-partner-colslaps-container__right-item-desc'}>
              <Input
