...
import {ShippingPartnerSkeleton} from '../../skelenton/shippingPartner'
  ...
  return (
    <StyledInventoryContainer {...props}>
      <div className="order-single-shipping-partner-container__radio-list">
        ...
        !state.skeleton || !(partner?.length > 0 && !!partner?.find(item => item?.connected)) ? (
          ''
        ) : (
        ...
        <div className={'order-single-shipping-partner-container__radio-item'}>
          {state.skeleton ? (
            ...
            <EmptyShippingPartner partner={partner} />
          )}
        </div>
      </div>
      ...
      >
        <div className={'shipping-partner-basic-container'}>
          <div className={'shipping-partner-basic-container__left'}>
            ...
            >
              <Radio
                checked={shippingPartner.selected == partner.id}
                name="partner-info"
                value={partner?.id}
...
const EmptyShippingPartner = ({partner}) => {
  return (
    <StyledEmptyShipping>
      <div className={'shipping-partner-empty-container'}>
        ...
        <div className="shipping-partner-empty-container__title">
          <Text color={!(partner?.length > 0 && !!partner?.find(item => item?.connected)) ? 'red' : ''}>
