...
export const SupplierImport = ({...props}) => {
  const {data,supplier, properties, methods} = useCreatePurchaseImportExcel()
      ...
      <AlternativeAutoComplete
        ...
        inputProps={{
          ...
          categoryValue: {name:  (<>
            ...
            </>), value: ''}, // if not exist this value -> default category: categoryList[0]
          categoryWidth: 115,
