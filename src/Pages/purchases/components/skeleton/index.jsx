    ...
    <>
      {SkelentonRows.map(i => (
        <Tr className="table_body" key={i}>
          <Td className="purchases-management-table__cell" align="center">
            <div style={{width: '100%'}}>
              <Skeleton width={'100%'} height={31} />
            </div>
          </Td>
          <Td className="purchases-management-table__cell" align="left">
            <div style={{width: '100%'}}>
          ...
          <Td className="purchases-management-table__cell" align="right">
