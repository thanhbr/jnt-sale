  ...
  return (
    <StyledRowTabShipping {...props}>
      ...
      {data?.order_detail?.length > 0 && (
        <div className="partSign-management-table__tab-detail-partSign">
          <TableContainer component={Paper}>
            <Table sx={{minWidth: 700}} aria-label="">
              <TableHead className="partSign-management-table__details-head">
                <TableRow>
              ...
              <TableBody className="partSign-management-table__details-body">
