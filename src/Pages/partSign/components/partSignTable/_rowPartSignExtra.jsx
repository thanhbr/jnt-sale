...
import {ORDER_TABLE_ROW_EXTRA_TABS} from 'Pages/partSign/interfaces/_constants'
import {useState} from 'react'
import styled from 'styled-components'
import {RowTabDetailDelivery} from './_rowTabDetailPartSign'
...
export const RowOrderExtra = ({active, data, arrDetail,onActionCancelDelivery, ...props}) => {
  ...
  return (
    <StyledRowOrderExtra {...props} data-active={active}>
      {active && (
        <div className="row-partSign-extra__container">
          <div className="row-partSign-extra__tabs">
            {ORDER_TABLE_ROW_EXTRA_TABS.map(item => (
              <div
                key={item.id}
                className="row-partSign-extra__tab"
          ...
          <div className="row-partSign-extra__content">
            {activeTab === 'detailDelivery' && <RowTabDetailDelivery data={data} onActionCancelDelivery={onActionCancelDelivery} />}
