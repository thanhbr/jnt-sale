...
import './DeliveryAdvancedSearch.scss'
...
export const DeliveryAdvancedSearch = ({...props}) => {
  const { t, i18n } = useTranslation()
  const {advancedSearch, badge, loading} = useDeliveryFilterForm()
  ...
  return (
    <>
      <Tooltip placement="bottom" title={t('advanced_search')}>
        <Button
