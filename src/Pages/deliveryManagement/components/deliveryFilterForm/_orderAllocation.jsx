...
export const OrderAllocation = () => {
  ...
  const {allocation} = useFilterForm()
  const ref = useRef()
  return (
    <>
      <CategoryInput
        ...
        categoryList={[]}
        categoryValue={{name: t('allocation_time'), value: '', icon: <Icon />}}
        categoryWidth={160}
        placeholdert={t('days_from_to')}
...
const Icon = () => {
  const {t, i18n} = useTranslation()
  return (
    <span className="order-filter-form__tooltip-allocation">
      <Tooltip
        placement="center"
        title={
