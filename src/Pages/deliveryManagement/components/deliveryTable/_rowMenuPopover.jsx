...
import { DELIVERY_TABLE_ROW_MENU_POPOVER } from 'Pages/deliveryManagement/interfaces/_constants'
...
export const RowMenuPopover = ({ onActionClick, ...props }) => {
  const [actionList, setActionList] = useState(DELIVERY_TABLE_ROW_MENU_POPOVER)
  ...
  useEffect(() => {
    let actionListOrigin = [...DELIVERY_TABLE_ROW_MENU_POPOVER]
