...
import './index.scss'
import {RowMenuPopover} from '../deliveryTable/_rowMenuPopover'
    ...
    <>
      {SkelentonRows.map(i => (
        <Tr className="table_body" key={i}>
          <Td className="delivery-management-table__cell" align="center">
            <div style={{width: '100%'}}>
              <Skeleton width={'100%'} height={31} />
            </div>
          </Td>
          <Td className="delivery-management-table__cell" align="left">
            <div style={{width: '100%'}}>
          ...
          <Td className="delivery-management-table__cell" align="right">
