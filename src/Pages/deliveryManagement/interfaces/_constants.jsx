...
export const DELIVERY_PAGE_HEADER_ACTIONS = [
...

  {
    ...
    type: 'dropdown',
    items: [
      {name: 'batch_order', url: '/tools/bulks-order'},
      {name: 'create_order', url: '/tools/shipping-tracking'}
    ],
...
export const ORDER_FILTER_FORM_DATE_TIME_SORT_TYPES = [
  ...
  {id: 2, name: 'order_create_date', value: 'created'},
  {id: 3, name: 'order_receive_date', value: 'received'},
  {id: 4, name: 'order_signed_date', value: 'singed'},
]

export const ORDER_FILTER_FORM_DUPLICATE_VALUES = [
  {id: 1, name: 'no_duplicate_filter', value: '0'},
  {id: 2, name: 'duplicate_filter', value: '1'},
]
...
export const DELIVERY_TABLE_ROW_MENU_POPOVER = [
  ...
  {id: 7, name: 'edit_COD_order', icon: DELIVERY_ICONS.edit05},
]
...
export const DELIVERY_TABLE_THEAD_PRINT_ACTIONS = [
  ...
  {id: 2, name: 'print_EVO_A4_template', icon: DELIVERY_ICONS.printer},
  {id: 3, name: 'print_EVO_A5_template', icon: DELIVERY_ICONS.printer},
  {id: 4, name: 'print_EVO_K80_template', icon: DELIVERY_ICONS.printer},
]
...
export const DELIVERY_DETAILS_LIST_TIME = [
  ...
  {id: 1, name: 'delivery_successful', value: ''},
]
